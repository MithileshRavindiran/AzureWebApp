...
. Clone the https://github.com/MithileshRavindiran/AzureWebApp.git[Spring Boot Getting Started] sample project into the directory you created by typing `git clone https://github.com/MithileshRavindiran/AzureWebApp.git`
